...
public class ConnectionConfig implements Cloneable {
    ...
    public static class Builder {
        ...
        public ConnectionConfig build() {
            ...
            int bufSize = this.bufferSize > 0 ? this.bufferSize : CacheConfig.DEFAULT_MAX_OBJECT_SIZE_BYTES;
    ...
    public String toString() {
        ...
        builder.append("[bufferSize=").append(this.bufferSize).append(", fragmentSizeHint=").append(this.fragmentSizeHint).append(", charset=").append(this.charset).append(", malformedInputAction=").append(this.malformedInputAction).append(", unmappableInputAction=").append(this.unmappableInputAction).append(", messageConstraints=").append(this.messageConstraints).append(RequestParameters.RIGHT_BRACKETS);
