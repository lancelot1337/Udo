...
public class FormBodyPartBuilder {
    ...
    public FormBodyPart build() {
        ...
        if (headerCopy.getField(HTTP.CONTENT_TYPE) == null) {
            ...
            if (contentType != null) {
                headerCopy.addField(new MinimalField(HTTP.CONTENT_TYPE, contentType.toString()));
            } else {
                buffer = new StringBuilder();
                ...
                headerCopy.addField(new MinimalField(HTTP.CONTENT_TYPE, buffer.toString()));
            }
        }
