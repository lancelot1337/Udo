...
public abstract class AbstractVerifier implements X509HostnameVerifier {
    ...
    public static String[] getCNs(X509Certificate cert) {
        if (new DistinguishedNameParser(cert.getSubjectX500Principal()).findMostSpecific("cn") == null) {
            return null;
        }
        return new String[]{new DistinguishedNameParser(cert.getSubjectX500Principal()).findMostSpecific("cn")};
    }
