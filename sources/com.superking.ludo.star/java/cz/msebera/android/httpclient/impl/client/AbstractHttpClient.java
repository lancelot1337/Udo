...
public abstract class AbstractHttpClient extends CloseableHttpClient {
    ...
    protected CookieSpecRegistry createCookieSpecRegistry() {
        ...
        registry.register(Branch.REFERRAL_BUCKET_DEFAULT, new BestMatchSpecFactory());
    ...
    protected final CloseableHttpResponse doExecute(HttpHost target, HttpRequest request, HttpContext context) throws IOException, ClientProtocolException {
        ...
        synchronized (this) {
            ...
            HttpContext httpContext = execContext;
            httpContext.setAttribute(ClientContext.REQUEST_CONFIG, HttpClientParamConfig.getRequestConfig(params));
