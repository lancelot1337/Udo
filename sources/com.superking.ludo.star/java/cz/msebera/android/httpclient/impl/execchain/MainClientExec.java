            ...
            while (true) {
                if (execCount <= 1 || RequestEntityProxy.isRepeatable(request)) {
                    ...
                    if (execAware == null || !execAware.isAborted()) {
                        ...
                        if (!request.containsHeader(HeaderConstants.AUTHORIZATION)) {
                            if (this.log.isDebugEnabled()) {
                        ...
                        if (!original.containsHeader(HeaderConstants.AUTHORIZATION)) {
                            request.removeHeaders(HeaderConstants.AUTHORIZATION);
                        }
