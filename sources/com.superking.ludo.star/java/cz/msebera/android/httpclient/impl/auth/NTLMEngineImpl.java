...
final class NTLMEngineImpl implements NTLMEngine {
    ...
    static class MD4 {
        ...
        byte[] getOutput() {
            ...
            NTLMEngineImpl.writeULong(result, this.B, NTLMEngineImpl.FLAG_REQUEST_TARGET);
        ...
        protected void processBuffer() {
            ...
            for (int i = 0; i < NTLMEngineImpl.FLAG_REQUEST_SIGN; i += NTLMEngineImpl.FLAG_REQUEST_UNICODE_ENCODING) {
                d[i] = (((this.dataBuffer[i * NTLMEngineImpl.FLAG_REQUEST_TARGET] & 255) + ((this.dataBuffer[(i * NTLMEngineImpl.FLAG_REQUEST_TARGET) + NTLMEngineImpl.FLAG_REQUEST_UNICODE_ENCODING] & 255) << 8)) + ((this.dataBuffer[(i * NTLMEngineImpl.FLAG_REQUEST_TARGET) + 2] & 255) << NTLMEngineImpl.FLAG_REQUEST_SIGN)) + ((this.dataBuffer[(i * NTLMEngineImpl.FLAG_REQUEST_TARGET) + 3] & 255) << 24);
            }
            int AA = this.A;
            int BB = this.B;
            int CC = this.C;
        ...
        protected void round1(int[] d) {
            ...
            this.D = NTLMEngineImpl.rotintlft((this.D + NTLMEngineImpl.F(this.A, this.B, this.C)) + d[NTLMEngineImpl.FLAG_REQUEST_UNICODE_ENCODING], 7);
            ...
            this.A = NTLMEngineImpl.rotintlft((this.A + NTLMEngineImpl.F(this.B, this.C, this.D)) + d[NTLMEngineImpl.FLAG_REQUEST_TARGET], 3);
        ...
        protected void round2(int[] d) {
            ...
            this.D = NTLMEngineImpl.rotintlft(((this.D + NTLMEngineImpl.G(this.A, this.B, this.C)) + d[NTLMEngineImpl.FLAG_REQUEST_TARGET]) + 1518500249, 5);
            ...
            this.A = NTLMEngineImpl.rotintlft(((this.A + NTLMEngineImpl.G(this.B, this.C, this.D)) + d[NTLMEngineImpl.FLAG_REQUEST_UNICODE_ENCODING]) + 1518500249, 3);
        ...
        protected void round3(int[] d) {
            ...
            this.C = NTLMEngineImpl.rotintlft(((this.C + NTLMEngineImpl.H(this.D, this.A, this.B)) + d[NTLMEngineImpl.FLAG_REQUEST_TARGET]) + 1859775393, 11);
            ...
            this.A = NTLMEngineImpl.rotintlft(((this.A + NTLMEngineImpl.H(this.B, this.C, this.D)) + d[NTLMEngineImpl.FLAG_REQUEST_UNICODE_ENCODING]) + 1859775393, 3);
    ...
    static class NTLMMessage {
        ...
        NTLMMessage(String messageBody, int expectedType) throws NTLMEngineException {
            this.messageContents = Base64.decode(messageBody.getBytes(NTLMEngineImpl.DEFAULT_CHARSET), 2);
        ...
        protected void addBytes(byte[] bytes) {
            if (bytes != null) {
                ...
                for (int i = 0; i < length; i += NTLMEngineImpl.FLAG_REQUEST_UNICODE_ENCODING) {
        ...
        protected void addULong(int value) {
            addByte((byte) (value & 255));
            addByte((byte) ((value >> 8) & 255));
            addByte((byte) ((value >> NTLMEngineImpl.FLAG_REQUEST_SIGN) & 255));
    ...
    private static int readULong(byte[] src, int index) throws NTLMEngineException {
        if (src.length >= index + FLAG_REQUEST_TARGET) {
            return (((src[index] & 255) | ((src[index + FLAG_REQUEST_UNICODE_ENCODING] & 255) << 8)) | ((src[index + 2] & 255) << FLAG_REQUEST_SIGN)) | ((src[index + 3] & 255) << 24);
        }
    ...
    private static int readUShort(byte[] src, int index) throws NTLMEngineException {
        if (src.length >= index + 2) {
            return (src[index] & 255) | ((src[index + FLAG_REQUEST_UNICODE_ENCODING] & 255) << 8);
        }
    ...
    private static Key createDESKey(byte[] bytes, int offset) {
        ...
        byte[] material = new byte[]{keyBytes[0], (byte) ((keyBytes[0] << 7) | ((keyBytes[FLAG_REQUEST_UNICODE_ENCODING] & 255) >>> FLAG_REQUEST_UNICODE_ENCODING)), (byte) ((keyBytes[FLAG_REQUEST_UNICODE_ENCODING] << 6) | ((keyBytes[2] & 255) >>> 2)), (byte) ((keyBytes[2] << 5) | ((keyBytes[3] & 255) >>> 3)), (byte) ((keyBytes[3] << FLAG_REQUEST_TARGET) | ((keyBytes[FLAG_REQUEST_TARGET] & 255) >>> FLAG_REQUEST_TARGET)), (byte) ((keyBytes[FLAG_REQUEST_TARGET] << 3) | ((keyBytes[5] & 255) >>> 5)), (byte) ((keyBytes[5] << 2) | ((keyBytes[6] & 255) >>> 6)), (byte) (keyBytes[6] << FLAG_REQUEST_UNICODE_ENCODING)};
        oddParity(material);
    ...
    static void writeULong(byte[] buffer, int value, int offset) {
        ...
        buffer[offset + FLAG_REQUEST_UNICODE_ENCODING] = (byte) ((value >> 8) & 255);
        buffer[offset + 2] = (byte) ((value >> FLAG_REQUEST_SIGN) & 255);
