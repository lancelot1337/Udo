...
public class PoolingHttpClientConnectionManager implements HttpClientConnectionManager, ConnPoolControl<HttpRoute>, Closeable {
    ...
    public PoolingHttpClientConnectionManager(HttpClientConnectionOperator httpClientConnectionOperator, HttpConnectionFactory<HttpRoute, ManagedHttpClientConnection> connFactory, long timeToLive, TimeUnit tunit) {
        ...
        this.pool.setValidateAfterInactivity(DownloadManager.OPERATION_TIMEOUT);
    ...
    private String format(HttpRoute route, Object state) {
        ...
        buf.append("[route: ").append(route).append(RequestParameters.RIGHT_BRACKETS);
        if (state != null) {
            buf.append("[state: ").append(state).append(RequestParameters.RIGHT_BRACKETS);
        }
        return buf.toString();
    }
    ...
    private String formatStats(HttpRoute route) {
        ...
        buf.append(" of ").append(totals.getMax()).append(RequestParameters.RIGHT_BRACKETS);
        return buf.toString();
    }

    private String format(CPoolEntry entry) {
        StringBuilder buf = new StringBuilder();
        buf.append("[id: ").append(entry.getId()).append(RequestParameters.RIGHT_BRACKETS);
        buf.append("[route: ").append(entry.getRoute()).append(RequestParameters.RIGHT_BRACKETS);
...
/*
Error: java.lang.NullPointerException: Attempt to invoke virtual method 'boolean jadx.core.dex.nodes.InsnNode.contains(jadx.core.dex.attributes.AFlag)' on a null object reference
