...
public class BasicConnFactory implements ConnFactory<HttpHost, HttpClientConnection> {
    ...
    protected HttpClientConnection create(Socket socket, HttpParams params) throws IOException {
        DefaultBHttpClientConnection conn = new DefaultBHttpClientConnection(params.getIntParameter(CoreConnectionPNames.SOCKET_BUFFER_SIZE, CacheConfig.DEFAULT_MAX_OBJECT_SIZE_BYTES));
        conn.bind(socket);
        return conn;
    }
