...
class Worker implements Runnable {
    ...
    public void run() {
        /*
        r5 = this;
        r2 = new cz.msebera.android.httpclient.protocol.BasicHttpContext;	 Catch:{ Exception -> 0x0022 }
        r2.<init>();	 Catch:{ Exception -> 0x0022 }
        r0 = cz.msebera.android.httpclient.protocol.HttpCoreContext.adapt(r2);	 Catch:{ Exception -> 0x0022 }
    L_0x0009:
    ...
    L_0x004e:
        ...
        goto L_0x004d;
        */
        throw new UnsupportedOperationException("Method not decompiled: cz.msebera.android.httpclient.impl.bootstrap.Worker.run():void");
    }
}
