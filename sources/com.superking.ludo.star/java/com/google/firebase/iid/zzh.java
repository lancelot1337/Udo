    ...
    static class zza {
        ...
        static String zzd(String str, String str2, long j) {
            try {
                ...
                jSONObject.put(EventEntry.COLUMN_NAME_TIMESTAMP, j);
        ...
        static zza zzjA(String str) {
            ...
            try {
                ...
                return new zza(jSONObject.getString("token"), jSONObject.getString(RequestParameters.APPLICATION_VERSION_NAME), jSONObject.getLong(EventEntry.COLUMN_NAME_TIMESTAMP));
            } catch (JSONException e) {
                String valueOf = String.valueOf(e);
