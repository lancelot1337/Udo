...
public class zzf {
    ...
    private void zzeF(String str) {
        if ("com.google.android.gsf".equals(zzbhQ)) {
            ...
            if (this.zzbib >= 3) {
                if (this.zzbib == 3) {
                    this.zzbic = new Random().nextInt(GameControllerDelegate.THUMBSTICK_LEFT_X) + GameControllerDelegate.THUMBSTICK_LEFT_X;
                }
                this.zzbic *= 2;
    ...
    void zzr(Intent intent) {
        ...
        if (longExtra > 0) {
            ...
            this.zzbic = ((int) longExtra) * GameControllerDelegate.THUMBSTICK_LEFT_X;
            this.zzbid = SystemClock.elapsedRealtime() + ((long) this.zzbic);
