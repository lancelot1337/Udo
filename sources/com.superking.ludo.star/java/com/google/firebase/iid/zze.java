...
public class zze {
    ...
    zze(zzh com_google_firebase_iid_zzh) {
        this.zzclv = com_google_firebase_iid_zzh;
    }
    ...
    void zzjt(String str) {
        synchronized (zztX) {
            String string = this.zzclv.zzabX().getString("topic_operaion_queue", BuildConfig.FLAVOR);
    ...
    boolean zzjx(String str) {
        ...
        synchronized (zztX) {
            ...
            if (string.startsWith(valueOf2.length() != 0 ? valueOf.concat(valueOf2) : new String(valueOf))) {
                ...
                this.zzclv.zzabX().edit().putString("topic_operaion_queue", string.substring((valueOf2.length() != 0 ? valueOf.concat(valueOf2) : new String(valueOf)).length())).apply();
                z = true;
            } else {
                z = false;
            }
