...
public class FirebaseInstanceIdService extends zzb {
    ...
    private void zzqG(int i) {
        ((AlarmManager) getSystemService("alarm")).set(3, SystemClock.elapsedRealtime() + ((long) (i * GameControllerDelegate.THUMBSTICK_LEFT_X)), zzg.zza(this, 0, zzqF(i * 2), 134217728));
    }
