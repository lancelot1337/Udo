...
class zza {
    ...
    static boolean zzE(Bundle bundle) {
        return ErrorCodes.FOLDER_NOT_EXIST_CODE.equals(zzf(bundle, "gcm.n.e")) || zzf(bundle, "gcm.n.icon") != null;
    }
    ...
    boolean zzG(Bundle bundle) {
        if (ErrorCodes.FOLDER_NOT_EXIST_CODE.equals(zzf(bundle, "gcm.n.noui"))) {
            return true;
        }
        if (zzaca()) {
            return false;
