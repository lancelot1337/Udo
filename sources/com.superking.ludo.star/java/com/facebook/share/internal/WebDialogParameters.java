...
public class WebDialogParameters {
    public static Bundle create(AppGroupCreationContent appGroupCreationContent) {
        ...
        Utility.putNonEmptyString(webParams, MediationMetaData.KEY_NAME, appGroupCreationContent.getName());
    ...
    public static Bundle create(GameRequestContent gameRequestContent) {
        ...
        Utility.putNonEmptyString(webParams, EventEntry.COLUMN_NAME_DATA, gameRequestContent.getData());
    ...
    public static Bundle createForFeed(ShareLinkContent shareLinkContent) {
        Bundle webParams = new Bundle();
        Utility.putNonEmptyString(webParams, MediationMetaData.KEY_NAME, shareLinkContent.getContentTitle());
    ...
    public static Bundle createForFeed(ShareFeedContent shareFeedContent) {
        ...
        Utility.putNonEmptyString(webParams, Param.SOURCE, shareFeedContent.getMediaSource());
        Utility.putNonEmptyString(webParams, MediationMetaData.KEY_NAME, shareFeedContent.getLinkName());
