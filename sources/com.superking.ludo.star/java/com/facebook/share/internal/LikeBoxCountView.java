...
public class LikeBoxCountView extends FrameLayout {
    ...
    private void initialize(Context context) {
        ...
        this.caretHeight = getResources().getDimension(com.facebook.R.dimen.com_facebook_likeboxcountview_caret_height);
        this.caretWidth = getResources().getDimension(com.facebook.R.dimen.com_facebook_likeboxcountview_caret_width);
        this.borderRadius = getResources().getDimension(com.facebook.R.dimen.com_facebook_likeboxcountview_border_radius);
        this.borderPaint = new Paint();
        this.borderPaint.setColor(getResources().getColor(com.facebook.R.color.com_facebook_likeboxcountview_border_color));
        this.borderPaint.setStrokeWidth(getResources().getDimension(com.facebook.R.dimen.com_facebook_likeboxcountview_border_width));
    ...
    private void initializeLikeCountLabel(Context context) {
        ...
        this.likeCountLabel.setTextSize(0, getResources().getDimension(com.facebook.R.dimen.com_facebook_likeboxcountview_text_size));
        this.likeCountLabel.setTextColor(getResources().getColor(com.facebook.R.color.com_facebook_likeboxcountview_text_color));
        this.textPadding = getResources().getDimensionPixelSize(com.facebook.R.dimen.com_facebook_likeboxcountview_text_padding);
        this.additionalTextPadding = getResources().getDimensionPixelSize(com.facebook.R.dimen.com_facebook_likeboxcountview_caret_height);
    }
