...
abstract class WebLoginMethodHandler extends LoginMethodHandler {
    ...
    protected Bundle getParameters(Request request) {
        ...
        parameters.putString(Constants.RESTORED_STATE, getClientState(request.getAuthId()));
        ...
        if (previousTokenString == null || !previousTokenString.equals(loadCookieToken())) {
            ...
            addLoggingExtra(ServerProtocol.DIALOG_PARAM_ACCESS_TOKEN, ErrorCodes.FOLDER_NOT_EXIST_CODE);
        }
        return parameters;
    }
