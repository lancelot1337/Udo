package com.superking.iap.billing;
...
public class IabHelper {
    ...
    public void startSetup(final OnIabSetupFinishedListener listener) {
            ...
            public void onServiceConnected(ComponentName name, IBinder service) {
                if (!IabHelper.this.mDisposed) {
                    ...
                    try {
                        ...
                        if (IabHelper.this.mService.isBillingSupported(IabHelper.BILLING_RESPONSE_RESULT_DEVELOPER_ERROR, packageName, IabHelper.ITEM_TYPE_SUBS) == 0) {
        ...
        List<ResolveInfo> intentServices = this.mContext.getPackageManager().queryIntentServices(serviceIntent, BILLING_RESPONSE_RESULT_OK);
        ...
        if (!itemType.equals(ITEM_TYPE_SUBS) || this.mSubscriptionsSupported) {
            ...
            try {
                ...
                if (oldSkus == null || oldSkus.isEmpty()) {
                    buyIntentBundle = this.mService.getBuyIntent(BILLING_RESPONSE_RESULT_BILLING_UNAVAILABLE, this.mContext.getPackageName(), sku, itemType, extraData);
                } else if (this.mSubscriptionUpdateSupported) {
                    buyIntentBundle = this.mService.getBuyIntentToReplaceSkus(BILLING_RESPONSE_RESULT_DEVELOPER_ERROR, this.mContext.getPackageName(), oldSkus, sku, itemType, extraData);
                } else {
