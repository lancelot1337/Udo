...
public class CappingManager {
    ...
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$com$ironsource$mediationsdk$model$PlacementCappingType = new int[PlacementCappingType.values().length];

        static {
            try {
                $SwitchMap$com$ironsource$mediationsdk$model$PlacementCappingType[PlacementCappingType.PER_DAY.ordinal()] = 1;
        ...
        synchronized (CappingManager.class) {
            if (!(context == null || placement == null)) {
                ...
                if (availabilitySettings != null) {
                    addCappingInfo(context, ParametersKeys.INTERSTITIAL, placement.getPlacementName(), availabilitySettings);
                }
            }
        }
    }
        ...
        synchronized (CappingManager.class) {
            if (!(context == null || placement == null)) {
                if (placement.getPlacementAvailabilitySettings() != null) {
                    isPlacementCapped = isPlacementCapped(context, ParametersKeys.INTERSTITIAL, placement.getPlacementName());
                }
            }
    ...
    public static synchronized ECappingStatus isPlacementCapped(Context context, BannerPlacement placement) {
        ...
        synchronized (CappingManager.class) {
            if (!(context == null || placement == null)) {
                if (placement.getPlacementAvailabilitySettings() != null) {
                    isPlacementCapped = isPlacementCapped(context, IronSourceConstants.BANNER_AD_UNIT, placement.getPlacementName());
                }
            }
            isPlacementCapped = ECappingStatus.NOT_CAPPED;
        }
    ...
    public static synchronized void incrementShowCounter(Context context, InterstitialPlacement placement) {
        synchronized (CappingManager.class) {
            if (placement != null) {
                incrementShowCounter(context, ParametersKeys.INTERSTITIAL, placement.getPlacementName());
            }
        }
    }
    ...
    private static ECappingStatus isPlacementCapped(Context context, String adUnit, String placementName) {
        ...
        if (IronSourceUtils.getBooleanFromSharedPrefs(context, constructSharedPrefsKey(adUnit, IS_PACING_ENABLED, placementName), false)) {
            if (currentTime - IronSourceUtils.getLongFromSharedPrefs(context, constructSharedPrefsKey(adUnit, TIME_OF_THE_PREVIOUS_SHOW, placementName), 0) < ((long) (IronSourceUtils.getIntFromSharedPrefs(context, constructSharedPrefsKey(adUnit, SECONDS_BETWEEN_SHOWS, placementName), 0) * GameControllerDelegate.THUMBSTICK_LEFT_X))) {
    ...
    private static long initTimeThreshold(PlacementCappingType cappingType) {
        ...
        switch (AnonymousClass1.$SwitchMap$com$ironsource$mediationsdk$model$PlacementCappingType[cappingType.ordinal()]) {
