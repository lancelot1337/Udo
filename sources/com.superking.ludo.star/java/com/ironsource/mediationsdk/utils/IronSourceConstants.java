...
public class IronSourceConstants {
    ...
    public static final int BANNER_AD_CLICKED = 408;
    public static final int BANNER_AD_OPENED = 405;
    public static final int BANNER_AD_READY_RESULT = 407;
    public static final String BANNER_AD_UNIT = "Banner";
    public static final int BANNER_PLACEMENT_CAPPED = 414;
    public static final int DESTROY_BANNER_CODE = 406;
    ...
    public static final int INTERSTITIAL_AD_READY_RESULT = 27;
    ...
    public static final int LOAD_BANNER_CODE = 402;
