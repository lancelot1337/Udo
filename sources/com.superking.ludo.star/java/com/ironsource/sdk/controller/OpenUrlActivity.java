...
public class OpenUrlActivity extends Activity {
    ...
    private class Client extends WebViewClient {
        ...
        public void onPageStarted(WebView view, String url, Bitmap favicon) {
            ...
            OpenUrlActivity.this.mProgressBar.setVisibility(OpenUrlActivity.PROGRESS_BAR_VIEW_ID);
        }
    ...
    public void loadUrl(String url) {
        ...
        try {
            ...
            new IronSourceAsyncHttpRequestTask().execute(new String[]{Constants.NATIVE_EXCEPTION_BASE_URL + e.getStackTrace()[PROGRESS_BAR_VIEW_ID].getMethodName()});
        }
    }
